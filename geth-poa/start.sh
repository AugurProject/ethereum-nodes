...
node_start() {
  ...
  nohup geth \
    ...
    --verbosity 2 --mine \
    --ws --wsapi eth,net,web3,personal --wsaddr 0.0.0.0 --wsport $WSPORT --wsorigins '*' \
    --rpc --rpcapi eth,net,web3,personal,miner --rpcaddr 0.0.0.0 --rpcport $RPCPORT --rpccorsdomain '*' \
