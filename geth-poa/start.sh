...
nohup geth \
  ...
  --verbosity 2 \
  --unlock "0xc5ed899b0878656feb06467e2e9ede3ae73cbcb7" \
  --mine \
  --ws --wsapi eth,net,web3,personal --wsport 8546 \
  --rpc --rpcapi eth,net,web3,personal,miner --rpcaddr 0.0.0.0 \
  --targetgaslimit 6500000 dumpconfig > config.toml
...
curl \
  ...
  -X POST \
  --data '{"jsonrpc":"2.0","method":"eth_sendTransaction","params":[{"value":"0x0","to":"0x0000000000000000000000000000000000000000","from":"0xc5ed899b0878656feb06467e2e9ede3ae73cbcb7","data":"0x","gasPrice":"0x1"}], "id": 1}'
